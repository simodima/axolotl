...
- If triggered:
  - Document the observation in `~/.axolotl/notes/YYYY-MM-DD_HHMM_<slug>.md` using the 4-part retrospective template or `.agents/skills/axolotl/scripts/record-note.sh`.
